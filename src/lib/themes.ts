...
export const DEFAULT_THEME: ThemeId = "forcom";
...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "forcom",
    name: "FORCOM",
    tagline: "El rojo de la marca — el mismo de forcom.tech.",
    swatch: "oklch(0.596 0.228 29.1)",
  },
  {
    id: "violet",
    name: "Violeta",
    tagline: "El original de wacrm — seguro, un poco jugado.",
    swatch: "oklch(0.526 0.247 293)",
  },
  {
    id: "emerald",
    name: "Esmeralda",
    tagline: "Verde de crecimiento, sin copiar el verde de WhatsApp.",
    swatch: "oklch(0.62 0.16 162)",
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul de software corporativo — sobrio y prolijo.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Ámbar",
    tagline: "Cálido y amigable — cómodo para equipos chicos.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Audaz y moderno — retail, lifestyle, marcas jóvenes.",
