      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          data.phone_info?.verified_name
            ? t('toastSavedLive', { name: data.phone_info.verified_name })
            : t('toastSavedConnected'),
        );
      ...
      if (payload.connected) {
        ...
        toast.success(
          payload.phone_info?.verified_name
            ? t('toastTestConnected', { name: payload.phone_info.verified_name })
            : t('toastTestSuccess')
        );
      } else {
        setConnectionStatus('disconnected');
